...
<div class="col-md-10">
<a href="mailto:chiraggoel.53784@gmail.com" style="color:#000000">ahsan575habib@gmail.com</a><br /><br />
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/BUBT.png" width=100 height=100 alt="Ahsan and Tahmid" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="http://yugeshverma.blogspot.in" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Ahsan and Tahmid</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+88 01565063741</h4>
		<h4 style="font-family:'typo' ">ahsan575habib@gmail.com</h4>
		<h4 style="font-family:'typo' ">Bangladesh University of Business and Technology (BUBT)</h4></div></div>
		</p>
      </div>
